package opening_game.view.result;
import opening_game.interface_adapter.opengame.OpenGameController;
import opening_game.interface_adapter.result.ResultController;
import opening_game.interface_adapter.result.ResultViewModel;
